...
public class MyPresentationActivity extends AppCompatActivity {
String userid = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Presentation");
    ...
    public void bindingData(){
        ...
        documentType = findViewById(R.id.spinnerDocumentType);

        save=findViewById(R.id.btnSavePresentation);
        ...
        selectImage = findViewById(R.id.selectImagePresentation);
    ...
    public  class getSelectDocumentType extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            // TODO Auto-generated method stub
            try {
                ServiceHandler shh = new ServiceHandler(MyPresentationActivity.this);

                jsonStr = shh.makeServiceCall("https://www.hbcbiz.in/apiV1/documents/getDocumentType", ServiceHandler.GET);
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Utils.showDialog(MyPresentationActivity.this, e.toString(), false, false);
                    }
                });
                // workerThread();
            ...
            try {
                if (jsonStr != null) {
                    ...
                    if (responseSuccess.equals("1000")) {
                        ...
                        Utils.showDialog(MyPresentationActivity.this, responseMsg, false, false);
                    }
                } else {
                }
            } catch (Exception e) {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                RequestBody values = new FormBody.Builder()
                        ...
                        .add("name",fileName)
                        .add("path",path.replace(fileName,""))
                        .add("ext",fileExt)
                        .build();
                jsonStr = shh.makeServiceCall("https://www.hbcbiz.in/apiV1/documents/documentsUpload", ServiceHandler.POST,values);
        ...
        protected void onPostExecute(String jsonStr) {
            ...
            try {
                if (jsonStr != null) {
                    ...
                    responseSuccess = String.valueOf(jsonData.getInt("message_code"));
                    if (responseSuccess.equals("1000")) {
                        String response = String.valueOf(jsonData.getInt("message_text"));
                        Log.d("uploadDocument",response.toString());
