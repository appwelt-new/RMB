...
public void bindingId() {
    ...
    save=findViewById(R.id.btnSaveVideo);
    ...
    selectImage = findViewById(R.id.selectImageVideo);
...
showFileChooser();
    ...
    documentType = findViewById(R.id.spinnerDocumentTypeVideo);
    ...
    public  class getSelectDocumentType extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            // TODO Auto-generated method stub
            try {
                ServiceHandler shh = new ServiceHandler(MyVideoActivity.this);
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Utils.showDialog(MyVideoActivity.this, e.toString(), false, false);
                    }
                });
                // workerThread();
            ...
            try {
                if (jsonStr != null) {
                    ...
                    if (responseSuccess.equals("1000")) {
                        ...
                        Utils.showDialog(MyVideoActivity.this, responseMsg, false, false);
                    }
                } else {
                }
            } catch (Exception e) {
